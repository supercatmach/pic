function stanbylondingContent() {
  const designWidth = 1800;
  const designHeight = 900;
  const scaler = document.querySelector(".stanbylonding");
...
window.addEventListener("DOMContentLoaded", stanbylondingContent);
window.addEventListener("resize", stanbylondingContent);
